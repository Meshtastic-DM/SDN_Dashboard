from sqlalchemy import Boolean, Column, Integer, LargeBinary, String, Float, DateTime
...
class Message(Base):
    ...
    converstation = Column(String)  # Optional: to group messages into conversations
